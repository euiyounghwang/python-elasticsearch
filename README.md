...
- Indexing through Logstash from Kafka Broker : Kafka producer/consumer (https://github.com/euiyounghwang/python-search_engine/blob/master/kafka/READMD.md), Kafka-Logstash-Elasticsearch, Kafka-Prometheus-Exporter for monitoring
