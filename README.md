...
- Single Node ES with Kibana based on 7.9.0 version (You have to choose to build & create REST-API Service and Pytest instances using `./docker-compose.yml` for interacting with single ES cluster)
```bash
